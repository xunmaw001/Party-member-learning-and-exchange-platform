        ...
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="开始时间" prop="kechengkaishiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.kechengkaishiTime"
                                type="datetime"
                                placeholder="开始时间"
                                :disabled="ro.kechengkaishiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kechengkaishiTime" label="开始时间" prop="kechengkaishiTime">
                            <span v-html="ruleForm.kechengkaishiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
