    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="资料信息名称" prop="ziliaoName">
                       <el-input v-model="ruleForm.ziliaoName"
                                 placeholder="资料信息名称" clearable  :readonly="ro.ziliaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="资料信息名称" prop="ziliaoName">
                           <el-input v-model="ruleForm.ziliaoName"
                                     placeholder="资料信息名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="资料信息编号" prop="ziliaoUuidNumber">
                       <el-input v-model="ruleForm.ziliaoUuidNumber"
                                 placeholder="资料信息编号" clearable  :readonly="ro.ziliaoUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="资料信息编号" prop="ziliaoUuidNumber">
                           <el-input v-model="ruleForm.ziliaoUuidNumber"
                                     placeholder="资料信息编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.ziliaoPhoto" label="资料信息封面" prop="ziliaoPhoto">
                        <file-upload
                            tip="点击上传资料信息封面"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.ziliaoPhoto" label="资料信息封面" prop="ziliaoPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="资料信息类型" prop="ziliaoTypes">
                        <el-select v-model="ruleForm.ziliaoTypes" :disabled="ro.ziliaoTypes" placeholder="请选择资料信息类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="资料信息类型" prop="ziliaoValue">
                        <el-input v-model="ruleForm.ziliaoValue"
                            placeholder="资料信息类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.ziliaoFile" label="资料信息下载" prop="ziliaoFile">
                        <file-upload
                                tip="点击上传资料信息下载"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.ziliaoFile" label="资料信息下载" prop="ziliaoFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.ziliaoFile"  >资料信息下载下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="资料信息介绍" prop="ziliaoContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.ziliaoContent" label="资料信息介绍" prop="ziliaoContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   ziliaoName: [
                              { required: true, message: '资料信息名称不能为空', trigger: 'blur' },
                          ],
                   ziliaoUuidNumber: [
                              { required: true, message: '资料信息编号不能为空', trigger: 'blur' },
                          ],
                   ziliaoPhoto: [
                              { required: true, message: '资料信息封面不能为空', trigger: 'blur' },
                          ],
                   ziliaoTypes: [
                              { required: true, message: '资料信息类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   ziliaoFile: [
                              { required: true, message: '资料信息下载不能为空', trigger: 'blur' },
                          ],
                   ziliaoContent: [
                              { required: true, message: '资料信息介绍不能为空', trigger: 'blur' },
                          ],
                   ziliaoDelete: [
