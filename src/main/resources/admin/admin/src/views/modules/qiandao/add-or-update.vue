    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="内容" prop="qiandaoText">
                        <el-input type="textarea"  :readonly="ro.qiandaoText" v-model="ruleForm.qiandaoText" placeholder="内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.qiandaoText" label="内容" prop="qiandaoText">
                            <span v-html="ruleForm.qiandaoText"></span>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="备注" prop="qiandaoBeizhu">
                       <el-input v-model="ruleForm.qiandaoBeizhu"
                                 placeholder="备注" clearable  :readonly="ro.qiandaoBeizhu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="备注" prop="qiandaoBeizhu">
                           <el-input v-model="ruleForm.qiandaoBeizhu"
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`qiandao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.qiandaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
